...
```bash
python3 tooling/hub_sweep.py --repo allenpd728/PleaNP --dry-run   # print, write nothing
python3 tooling/hub_sweep.py --repo allenpd728/PleaNP             # append one snapshot
```
