...
```bash
python3 tooling/hub_sweep.py --repo philipdallen/PleaNP --dry-run   # print, write nothing
python3 tooling/hub_sweep.py --repo philipdallen/PleaNP             # append one snapshot
```
