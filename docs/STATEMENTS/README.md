...
| [`oracle-word-query-blackbox-audit.md`](./oracle-word-query-blackbox-audit.md) | Cross-domain black-box audit for the word-query substrate (why infinite query values need finite machine syntax; DEC-024/#39) | 2 (substrate rationale) | Written — plain-words survey over math/eng/physics domains |
