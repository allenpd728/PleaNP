...
| `docs/EXPLAINER_PVPNP_NARRATIVE.md` | **A plain-words explainer of P vs NP and PleaNP** (no math background needed, no external links) — for podcast/explainer use. Covers checking-vs-solving, Turing machines, oracles, the three barriers, Lean 4, the AI pipeline, and the GitHub workflow. |
