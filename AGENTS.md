...
| `.github/workflows/ci.yml` | **DEC-013 Active:** CI gates on the clean modules (Basic + Barrier Calculus) with a Mathlib olean cache-restore step; full-tree `lake build` returns when the v3 Oracle.lean debt is repaired (SORRY_TRACKER). |
